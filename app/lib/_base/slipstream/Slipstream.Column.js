			...
			render : function (classes) {
				...
				switch (this.type) {
					case InputTypes.textarea:
						this.html = "<textarea id='"+this.name+"' placeholder='" + this.placeholder + "' class='" + this.type + ' '
							+ classes
							+ "'>" + value
							+ "</textarea>";
						break;
					...
					case InputTypes.text:
						this.html = "<input id='"+this.name+"' type='" + this.type + "' placeholder='" + this.placeholder + "' value='"
